# -*- coding: utf-8 -*-
"""
Created on Tue Apr 16 22:08:12 2019
...
for q in range(0,500):
    ...
    errors = pd.DataFrame(np.add(auto_data[:in_fraction,:],-x_in))
    A=np.zeros((5))
    A[0]=chi2test(errors)
...
outcomes_rej_chi2_mooi.to_csv('./data/results/outcomes_rej_chi_cac.csv')
...
outcomes_rej_both_mooi.to_csv('./data/results/outcomes_rej_both_cac.csv')
