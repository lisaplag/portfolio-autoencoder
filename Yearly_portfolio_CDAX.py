...
pd.DataFrame(np.concatenate([log_returns_diag, log_returns_original_mean, log_returns_threshold], axis=1)).to_csv('./data/results/yearly_portfolio_returns_CDAX2.csv')
