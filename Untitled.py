...
different_epochs=[100,500,2000]
different_depths=[1,2,3,4,5]
different_neurons=[500,250]
...
for i in range(0,3):
  for l in range(0,5):
    for m in range(0,2):
      ...
      rn.seed(12345)        
      tf.set_random_seed(1234)
      errors=np.add(advanced_autoencoder(x_in,different_epochs[i],10,'elu',different_depths[l],different_neurons[m]),-x_in)
      results[i,l,m]=chi2test(errors)
