...
outcomes_mooi.to_csv('./data/results/outcomes18.csv')
...
outcomes_rej_pes_mooi.to_csv('./data/results/outcomes_rej_pes18.csv')
...
outcomes_rej_chi2_mooi.to_csv('./data/results/outcomes_rej_chi218.csv')
...
outcomes_rej_both_mooi.to_csv('./data/results/outcomes_rej_both18.csv')
